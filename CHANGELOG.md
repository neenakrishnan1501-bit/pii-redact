...
## [1.1.1] - 2026-03-18
### Fixed
- Synchronized package release explicitly to push new documentation to the npm registry.
- Embedded JSDoc typings for `redactObject` directly into the `.d.ts` declaration files for IDE intellisense.
